...
function App() {
  const [windows, setWindows] = useState({
    ...
    calculator: { visible: false, minimized: false, maximized: false, top: 150, left: 250 },
  ...
  const renderWindow = (key, Component) => {
    ...
    return (
      ...
      >
        ...
        <div
          style={{
            padding: key === "stocks" || key === "experience" || key === "paint" || key === "calculator" ? "0" : "10px",
            flex: 1,
            overflow: "auto",
  ...
  return (
    ...
    >
      ...
      <div style={iconContainerStyle}>
        ...
        <DesktopIcon label="Calculator" icon="/icons/file.png" onClick={() => toggleWindow("calculator", "visible")} />
      </div>
      ...
      {renderWindow("calculator", Calculator)}
        ...
        <div>
          ...
          {startMenuOpen && (
            <div style={startMenuStyle}>
              {["home", "about", "projects", "designprojects", "experience", "resume", "music", "photos", "email", "stocks", "susubot", "paint", "calculator"].map(key => (
                <div
                  key={key}
                  style={startMenuItem}
                  onClick={() => {
